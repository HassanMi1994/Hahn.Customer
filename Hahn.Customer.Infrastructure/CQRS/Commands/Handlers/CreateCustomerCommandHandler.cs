...
namespace Hahn.Customers.Infrastructure.CQRS.Commands.Handlers
{
    public class CreateCustomerCommandHandler : IRequestHandler<CreateCustomerCommand, Customer>
    {
        ...
        public async Task<Customer> Handle(CreateCustomerCommand request, CancellationToken cancellationToken)
        {
            ...
            customer.AddDomainEvent(new CustomerCreatedDomainEvent(customer.Id, customer.FirstName, customer.LastName, customer.DateOfBirth, customer.Email, customer.BankAccountNumber));
